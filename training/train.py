...
import sys
sys.path.append("/aifs4su/liuxinyu/cogvideox-factory/training")
...
from utils import get_gradient_norm, get_optimizer, prepare_rotary_positional_embeddings, print_memory, reset_memory
    ...
    for tracker in accelerator.trackers:
        ...
        if tracker.name == "wandb":
            ...
            for i, video in enumerate(videos):
                ...
                filename = os.path.join(args.output_dir, f"{phase_name}_video_e{epoch}_i{i}_{prompt}.mp4")
